...
namespace CapaPresentacionAdmin.Controllers
{
    ...
    public class MantenedorController : Controller
    {
        ...
        public JsonResult ImagenProducto(int id)
        {
            ...
            string textBase64 = CN_Recursos.ConvertirBase64(Path.Combine(oProducto.RutaImagen, oProducto.NombreImagen), out conversion);

            return Json(new {conversion = conversion, textBase64 = textBase64 , extension = Path.GetExtension(oProducto.NombreImagen)}, JsonRequestBehavior.AllowGet);
        }
