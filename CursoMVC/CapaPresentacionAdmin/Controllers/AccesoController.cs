...
namespace CapaPresentacionAdmin.Controllers
{
    public class AccesoController : Controller
    {
        ...
        public ActionResult Index(string correo, string clave)
        {
            ...
            if(oUsuario == null)
            {
                ViewBag.Error = "Correo o contraseña no correcta"; //Guarda informacion que se va a compartir con la vista
                return View();
            }
            else
            {
                ...
                {
                    TempData["IdUsuario"] = oUsuario.IdUsuario; //Como esta redireccionando a otra vista TemData nos permite guardar informacion y compartirlo a otra vista
